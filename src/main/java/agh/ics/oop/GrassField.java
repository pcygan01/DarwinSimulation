...
public class GrassField extends IWorldMap, IPositionChangeObserver{
    private final int n;
    private Map<Vector2d, Animal> animals;
    private Map<Vector2d, Grass> grasses;
//    private MapBoundary mapBoundaries;
    private final int borderType; //0 - kula ziemska, 1 - piekielny portal
    private final int grassesType; //0 - zalesione równiki, 1 - toksyczne trupy
